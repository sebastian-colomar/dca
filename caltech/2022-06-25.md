...
```
```
#Go to Worker1 node and run the kubeadm join command copied in Step 2.3 to join this node as a worker node to the cluster:
sudo kubeadm join 172.31.59.4:6443 --token 313500.6gx9jn0o4ih1rxux --discovery-token-ca-cert-hash sha256:ef95399f53d1ff2bfe98657e65ff97910bb74faedc9860b069b3107ba8d06569 
```
