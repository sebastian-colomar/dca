...
sudo docker service create                                    --publish 80:80 --read-only --secret source=index.php,target=/data/index.php,mode=0400,uid=65534                                        academiaonline/php:metadata
sudo docker service create --entrypoint docker-php-entrypoint --publish 80:80 --read-only --secret source=index.php,target=/data/index.php,mode=0400,uid=65534 --user nobody:nogroup --workdir /data/ academiaonline/php:metadata -f index.php -S 0.0.0.0:80
sudo docker service create --entrypoint docker-php-entrypoint --publish 80:80 --read-only --secret source=index.php,target=/data/index.php,mode=0400,uid=65534 --user nobody:nogroup --workdir /data/ php                         -f index.php -S 0.0.0.0:80
sudo docker service create --entrypoint docker-php-entrypoint --publish 80:80 --read-only --config source=index.php,target=/data/index.php,mode=0400,uid=65534 --user nobody:nogroup --workdir /data/ php                         -f index.php -S 0.0.0.0:80
```
