...
1. Add a new instance and initialize the kubernetes cluster master node:
   ...
   ```
   kubeadm join 192.168.0.13:6443 --token vz62an.sukbig1y0njsy9db \
    --discovery-token-ca-cert-hash sha256:fc04257351d61322577d551e4a543a488d2a39afc1333cd07839a9a4c2e39b88
...
1. Check the status of the deployment:
   ...
   kubectl get all
   ```
1. Add a new instance and join the master node:
...
1. Check again the status of the deployment:
   ...
   kubectl get all
   ```
1. In order to remove the previous deployment run the following command:
