...
docker run --detach --entrypoint php --name php-safe --publish 40000:8080 --read-only --restart always --user nobody:nogroup --workdir /my_app/ localhost:5000/my_library/my_php:alpine -f /index.php -S 0.0.0.0:8080
```
