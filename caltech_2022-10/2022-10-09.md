...
$
```
Remember that you can find the list of layers inspecting the Docker image in the section Graph Driver where Upper Directory will correspond to the last layer (that is the 9th layer in this case) and the Lower Directory will list the rest of the inner layers:
```
