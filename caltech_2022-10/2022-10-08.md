...
These packages were installed by the second line of the Dockerfile and they are therefore contained inside the second layer of the Lower Directory as can be checked with the following commands:
```
